...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.health-service.gs101.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/uwb-default.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.google.edgetpu_vendor_service@1.0-service.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.google.exo_camera_injection@1.1-service.xml
